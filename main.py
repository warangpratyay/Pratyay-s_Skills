...
def predict():
    ...
    keywords = {'Requirements': 3, 'Python,': 4, 'Machine': 5, 'Basis': 6, 'Kernel': 7, 'team': 8, 'python': 4, 'positive': 2, 'switch': 2, 'solutions': 3, 'python': 4, 'machine': 5, 'basis': 9, 'automation': 10, 'NLP': 8, 'administration': 9, 'Automation,':10, 'RPA': 10, 'creative': 10}
    matching_skills = []
